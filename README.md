...
This package makes it easy to send notifications using [Amazon Simple Notification Service (Amazon SNS)](link to service) with Laravel 5.5+ and 6.0
...
- [Installation](#installation)
	- [Setting up the AWS SNS service](#setting-up-the-aws-sns-service)
- [Usage](#usage)
...
If you discover any security related issues, please email fabio.savina@gmail.com instead of using the issue tracker.
...
- [Fabio Savina](https://github.com/fsavina)
